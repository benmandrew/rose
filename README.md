...
Set the timeout to whatever you wish; the performance of the webpage is bounded by the graph size, so if it's too slow, drop this lower to get a smaller graph.
